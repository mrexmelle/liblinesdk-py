...
def send_image_message(access_token, to, to_type, original_content_url, preview_image_url):
...
def send_video_message(access_token, to, to_type, original_content_url, preview_image_url):
    content={'contentType': ContentType.video, 'toType': to_type,
        'originalContentUrl': original_content_url, 'previewImageUrl': preview_image_url}
    return send_message(access_token, to, content)

def send_audio_message(access_token, to, to_type, original_content_url, audio_length):
